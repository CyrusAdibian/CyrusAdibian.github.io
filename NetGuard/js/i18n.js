(function () {
  ...
  const translations = {
    ...
    '، هوش مصنوعی امنیتی، فایروال WAF، اسکنر بدافزار، زیروتراست و SIEM.': ', AI security advisor, WAF firewall, malware scanner, Zero Trust, and SIEM.',
    'نت‌گارد چه امکاناتی دارد؟': 'What does NetGuard include?',
    'شانزده ماژول امنیتی، سه لایه حفاظتی و یک پلتفرم یکپارچه برای وردپرس.': 'Sixteen security modules, three protection layers, and one unified platform for WordPress.',
    'نسخه 1.0.1': 'Version 1.0.1',
    'هوش تهدید': 'Threat Intelligence',
    'پایگاه داده IoC، موتور اعتبارسنجی تهدید و فیدهای GreyNoise و MISP برای تشخیص IPها، دامنه‌ها و URLهای مخرب.': 'IoC database, threat validation engine, and GreyNoise and MISP feeds for detecting malicious IPs, domains, and URLs.',
    'حالت یادگیری فایروال': 'Firewall Learning Mode',
    'فایروال هوشمند با یادگیری الگوی ترافیک سالم؛ شناسایی و مسدودسازی خودکار رفتارهای مخرب.': 'Smart firewall that learns healthy traffic patterns and automatically detects and blocks malicious behavior.',
    'مسدودسازی بر اساس کشور': 'Country-Based Blocking',
    'کنترل دسترسی جغرافیایی با فیلتر کشورها و مسدودسازی ترافیک از مناطق پرریسک.': 'Geographic access control with country filtering and blocking traffic from high-risk regions.',
    'پشتیبان‌گیری و بازیابی': 'Backup and Recovery',
    'پشتیبان‌گیری زمان‌بندی‌شده از تنظیمات، محتوا و دیتابیس؛ رمزنگاری، ذخیره‌سازی Offsite با S3 و بازیابی پشتیبان.': 'Scheduled backups of settings, content, and database; encryption, offsite S3 storage, and restore.',
    'مدیریت Multisite': 'Multisite Management',
    'پشتیبانی از WordPress Multisite با مدیریت متمرکز سیاست‌های امنیتی، اعمال خودکار و همگام‌سازی Edge WAF.': 'WordPress Multisite support with centralized security policy management, auto-apply, and Edge WAF sync.',
    'قرنطینه و پاک‌سازی': 'Quarantine and Cleanup',
    'قرنطینه خودکار فایل‌های آلوده، بازیابی فایل‌های قرنطینه‌شده و حذف بدافزار؛ محافظت از مسیرهای حساس.': 'Auto-quarantine of infected files, restore from quarantine, and malware removal; protection of sensitive paths.',
    'انطباق امنیتی': 'Security Compliance',
    'چارچوب‌های انطباق SOC 2، ISO 27001 و PCI DSS با بررسی وضعیت، امتیازدهی و گزارش PDF/CSV.': 'SOC 2, ISO 27001, and PCI DSS compliance frameworks with status checks, scoring, and PDF/CSV reports.',
    'CAPTCHA و مدیریت ربات': 'CAPTCHA and Bot Management',
    'CAPTCHA داخلی، ریاضی، Cloudflare Turnstile، hCaptcha و Google reCAPTCHA؛ مسدودسازی ربات‌ها و درخواست‌های خودکار.': 'Built-in, math, Cloudflare Turnstile, hCaptcha, and Google reCAPTCHA challenges; blocks bots and automated requests.',
    'لاگ ممیزی': 'Audit Log',
    'ثبت پایدار رویدادهای امنیتی، ورودها و تغییرات مدیریتی با سطح شدت، جستجو، فیلتر و خروجی JSON/CSV/PDF.': 'Persistent security event, login, and admin-change logging with severity, search, filters, and JSON/CSV/PDF export.',
    'هوش مصنوعی امنیتی': 'AI Security Advisor',
    ...
    'فایروال، احراز هویت، اسکنر، پایش، ممیزی، آسیب‌پذیری، زیروتراست، AI، سندباکس و بیشتر؛ یک افزونه با ۱۶ ماژول امنیتی در ۳ لایه حفاظتی.': 'Firewall, authentication, scanner, monitoring, audit, vulnerability, Zero Trust, AI, sandbox, and more; one plugin with 16 security modules across 3 protection layers.',
